    ...
    return (
        <div className="container">
            ...
            <form className="form">
                ...
                <div className="img">
                    <div className="sicl"></div>
                    <button className="yuklash">Yuklash</button>
                </div>

                <div className="name">
                    <label>
                        <span>Kompaniya nomi *</span>
                        <input className="name input" type="text" placeholder="Kompaniya nomi" />
                    </label>
                    <label>
                        <span>Email *</span>
                    ...
                    <label>
                        ...
                        <input className="raqam input" type="number" placeholder="Namuna: 901234567" />
                    </label>
                    <div className="links">
                        <label>
                            <span>Linklar *</span>
                    ...
                    <label className="region">
                        <div className="davlat">
                            <span>Davlat *</span>
                            <input className="name dav" type="text" placeholder="Kompaniya nomi" />
                        </div>
                    ...
                    <label>
                        ...
                        <input className="name input" type="text" placeholder="Joy" />
                    </label>
                    <label>
                        <span>Hodimlar soni *</span>
                        <input className="name input" type="number" placeholder="Hodimlar soni" />
                    </label>
                    <label>
                        <span>Izoh *</span>
                        <textarea className="desc" placeholder="Kompaniya haqida izoh qoldiring" ></textarea>
                    </label>
                </div>
            </form>
            <div className="footer">
                <button className="btn orqabtn">Ortga</button>
                <button className="btn oldbtn">Keyingisi</button>
            </div>
        </div>
    );
}
